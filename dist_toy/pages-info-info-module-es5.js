...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-info-info-module"], {
  ...
  /***/
  function srcAppPagesInfoInfoInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var echarts_lib_chart_treemap__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(echarts_lib_chart_treemap__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */
    ...
    function InfoComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function InfoComponent_div_0_Template_button_click_1_listener() {
    ...
    var InfoComponent = /*#__PURE__*/function () {
      ...
      _createClass(InfoComponent, [{
        ...
        value: function returnAllData() {
          return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].base + "/static/web/assets/data.json").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            data = data;
            var chartOption = {
              tooltip: {
                show: false,
    ...
    InfoComponent.ɵfac = function InfoComponent_Factory(t) {
      return new (t || InfoComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
    ...
    InfoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 4,
      consts: [["class", "overlay page__content vmargin-right-20 vmargin-left-20", 4, "ngIf"], ["echarts", "", "class", "echart", 3, "options", 4, "ngIf"], [1, "overlay", "page__content", "vmargin-right-20", "vmargin-left-20"], ["mat-icon-button", "", 1, "top-25", "exit", "float-right", 3, "click"], ["aria-label", "hide overlay"], [1, "margin-top-50"], ["echarts", "", 1, "echart", 3, "options"]],
